...
- :doc:`Android Java SIP voice and video client application <java-sip-client>`, a very simple
  softphone demo but yet already packed with powerful features,
- :doc:`Android Kotlin SIP client application <kotlin-sip-client>`, and
- :doc:`Android CLI based remote controllable (telnet) SIP application <cli-sip-client>` for rapid feature
  development and testing

In the coming pages, we'll give you step by step tutorial to build, run, and use these sample
applications.
