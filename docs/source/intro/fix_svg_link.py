...
def fix_doc(doc):
    ...
    https://www.google.com/url?q=https://docs.pjsip.org/en/latest/pjsua2/intro_pjsua2.html&sa=D&source=editors&ust=1659235746911254&usg=AOvVaw0blDn1r0dJHBs2eRJ777EU

    to:

    ../api/pjsip.html
    """
    doc = re.sub(r'href=".*?google.*?/latest/([a-zA-Z0-9_\-/]+)\.html.*?"', 
                 r'href="../\1.html"', 
